...
public class WaterWaveView extends View {
    ...
    private final List<Wave> mWaves = new ArrayList<>();
    ...
    private void init() {
        setWaveInfo(60f, 2f, 2f, 15f, Color.WHITE);
        mWaveIntervalSize = DisplayUtil.dip2px(getContext(), 10);
        mWidth = DisplayUtil.dip2px(getContext(), 2);
        mWaveEndWidth = DisplayUtil.dip2px(getContext(), 60);
    }
